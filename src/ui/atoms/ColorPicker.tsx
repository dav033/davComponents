  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        disabled={disabled}
        className={cx(
          "flex items-center gap-3 rounded-lg border border-theme-gray-subtle bg-theme-dark px-3 py-2 transition-colors",
          "hover:border-gray-500 disabled:cursor-not-allowed disabled:opacity-50"
        )}
      >
        <div
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="font-mono text-sm text-theme-light">{(value || "#000000").toUpperCase()}</span>
        </div>
      </button>
