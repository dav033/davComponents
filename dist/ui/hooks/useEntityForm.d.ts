import type { UseToast } from "../types/notifications";
...
export declare function useEntityForm<T extends {
    id: number;
}, TFormValue, TPatch>({ initialFormValue, toPatch, updateFn, invalidateKeys, successMessage, errorMessage, onSuccess, notifications, }: UseEntityFormOptions<T, TFormValue, TPatch>): UseEntityFormResult<T, TFormValue>;
